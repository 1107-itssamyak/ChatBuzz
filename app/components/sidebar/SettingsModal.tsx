                        ...
                        <div className="mt-10 flex flex-col gap-y-8">
                            ...
                            <div>
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    <Image width="45" height="45" className="rounded-lg" src={image || currentUser?.image || '/images/placeholder.jpg'} alt="Avatar" />
                                    <CldUploadButton options={{ maxFiles: 1 }} onUpload={handleUpload} uploadPreset="y7hmj1vc">
                                        Change
                                    </CldUploadButton>
                                </div>
                            </div>
